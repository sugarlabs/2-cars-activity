...
redcircle=pygame.transform.scale(pygame.image.load("assets/redcircle.png"),(40,40))
bluecircle= pygame.transform.scale(pygame.image.load("assets/bluecircle.png"),(40,40))

    

redsquare= pygame.transform.scale(pygame.image.load("assets/redsquare.png"),(40,40))
bluesquare= pygame.transform.scale(pygame.image.load("assets/bluesquare.png"),(40,40))   
